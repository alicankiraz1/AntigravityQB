# AntigravityQB Project Comprehension Methods
...
`Planner-docs/Project-Comprehension.md` captures what AntigravityQB believes about a project, why it believes it, how confident it is, and what still needs validation.
...
```text
antigravityqb_schema_version: 2
```
