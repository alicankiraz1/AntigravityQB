...
Use it only after Step 3 writes `Planner-docs/Sub-Planing-Audit.md` and the audit says Step 4 can begin. Print the copy block below for the user to paste into a new Antigravity task or conversation.
...
9. Append or update `Planner-docs/Planing-Ledger.md` with a concise implementation summary for the verified slice or stop event. If the ledger does not exist, create it using the structure from AntigravityQB planning-ledger guidance.
10. Summarize:
   - files changed;
